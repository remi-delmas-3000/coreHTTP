...
cp gotos/httpParserOnHeadersCompleteCallback_harness1.goto main.o
...
--dfcc httpParserOnHeadersCompleteCallback_harness \
--replace-call-with-contract onHeaderCallbackContract \
--enforce-contract __CPROVER_file_local_core_http_client_c_httpParserOnHeadersCompleteCallback \
