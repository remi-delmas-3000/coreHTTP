...
cp gotos/httpParserOnMessageCompleteCallback_harness1.goto main.o
...
--dfcc httpParserOnMessageCompleteCallback_harness \
--enforce-contract __CPROVER_file_local_core_http_client_c_httpParserOnMessageCompleteCallback \
